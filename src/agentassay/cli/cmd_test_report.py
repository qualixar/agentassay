...
def _generate_test_report_html(
    ...
    # Compute bar fill class
    bar_fill_class = (
        "fill-green" if pass_rate >= 80 else "fill-yellow" if pass_rate >= 50 else "fill-red"
    )
...
<div class="card">
  ...
  <div class="bar-container">
    <div class="bar-fill {bar_fill_class}" style="width: {pass_rate}%;"></div>
