...
<div class="card">
  ...
  <div class="bar-container" style="height: 24px;">
    {% set bar_color = "fill-green" if pass_rate >= 0.8 else "fill-yellow" if pass_rate >= 0.5 else "fill-red" %}  {# noqa: E501 #}
...
<div class="card">
  ...
  <div class="heatmap-row">
    ...
    <div class="bar-container" style="flex: 1; height: 24px;">
      {% set c = "fill-green" if dim_val >= 0.8 else "fill-yellow" if dim_val >= 0.5 else "fill-red" %}  {# noqa: E501 #}
...
<div class="card">
  ...
  <div class="kpi-row">
    <div class="kpi">
      ...
      <div class="value"
           style="color: {{ '#3fb950' if mutation_report.mutation_score >= 0.8 else '#bb8009' if mutation_report.mutation_score >= 0.5 else '#f85149' }};">  {# noqa: E501 #}
      ...
      <tr>
        ...
        <td>
          <div class="bar-container" style="height: 16px;">
            {% set c = "fill-green" if score >= 0.8 else "fill-yellow" if score >= 0.5 else "fill-red" %}  {# noqa: E501 #}
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        {# noqa: E501 - template line #}
        <td style="font-size: 0.8rem; color: #8b949e;">
          {{ gate_decision.scenario_reasons.get(name, '') }}
        </td>
      </tr>
      {% endfor %}
    </tbody>
...
<div class="card">
  ...
  <div class="kpi-row">
    <div class="kpi">
      ...
      <div class="value"
           style="color: {{ '#3fb950' if metamorphic_report.violation_rate <= 0.1 else '#bb8009' if metamorphic_report.violation_rate <= 0.3 else '#f85149' }};">  {# noqa: E501 #}
    ...
    <div class="kpi">
      ...
      <div class="value" style="color: #3fb950;">
        {{ metamorphic_report.total_relations - metamorphic_report.violations }}
      </div>
    </div>
  </div>
...
<div class="footer">
  ...
  <div class="qualixar-attribution">
    <p>Generated by AgentAssay v{{ version }} | Part of Qualixar</p>
    <p>
...
class HTMLReporter:
    ...
    def __init__(self) -> None:
        ...
        self._signer = QualixarSigner()
        self._watermark = QualixarWatermark()
    ...
    def generate_report(self, data: dict[str, Any]) -> str:
        ...
        # Layer 3: Embed watermark in HTML
        html = self._watermark.embed(html)
    ...
    def _build_context(self, data: dict[str, Any]) -> dict[str, Any]:
        ...
        ctx: dict[str, Any] = {
            ...
            "timestamp": timestamp,
            "version": agentassay.__version__,
            "verdict": None,
        ...
        if trial_results:
            ...
            ctx["mean_score"] = sum(r.score for r in trial_results) / n if n > 0 else 0.0
            ctx["total_cost"] = sum(r.trace.total_cost_usd for r in trial_results)
